Pod::Spec.new do |s|
  ...
  s.license      = 'MIT'
  s.platform     = :ios, '7.0'  
  s.summary      = 'Small UIControl for presenting a menu with any number of menu items with a nice open and close animation. Supports multiple directions, mask types, and configurable animation options.'
